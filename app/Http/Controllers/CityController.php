...

{
...

    {
        ...
        try {
            ...
            $maxcityId = MasterCity::max('id'); // Ambil nilai city_id maksimum

            $city->id = $maxcityId ? $maxcityId + 1 : 1; // Set city_id, mulai dari 1 jika tidak ada
...

    {
        ...
        $city = MasterCity::where('id', $cityId)->first();
