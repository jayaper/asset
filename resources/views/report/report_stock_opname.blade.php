  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Report Stock Asset </h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Report Stock Asset</li>
                  </ol>
                </div>
              </div>
            </div>
    ...
    <i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Data
                ...
                <div class="container">
                      <div class="card">
                          <div class="card-body">
                            <a href="{{ url('/reports/export_excel_disposal_out') }}" class="btn btn-square btn-primary" role="button">
                                <i class="fa fa-file-excel-o" aria-hidden="true"></i> Download Excel Data
                            </a>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js" integrity="sha384-+sLIOodYLS7CIrQpBjl+C7nPvqq+FbNUBDunl/OZv93DB7Ln/533i8e/mZXLi/P+" crossorigin="anonymous"></script>
    ...
    "ajax": {
        "url": "/reports/get_data_stock_opname",
        "type": "GET",
        "dataSrc": ""
    },
    "columns" : [
    ...
    "data": "deleted_at",
    "render": function(data, type, row) {
        const status = data === null ? "Active" : "Not Active";
        const color = data === null ? "green" : "red";
