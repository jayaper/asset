                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Report Kartu Stock</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-end">
                                            <div class="col-sm-4 mb-3 text-end">
                                                <form class="row" action="/reports/kartu_stock_asset" method="get" enctype="multipart/form-data">
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" name="search" value="{{ request('search') }}" placeholder="Search Asset Or Location...">
                                                    </div>
                                                    <div class="col-lg-4 d-flex align-item-end">
                                                        <button class="btn btn-primary" type="submit">Search</button>
                                                        <a href="/reports/kartu_stock_asset" class="btn btn-secondary">Reset</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                ...
                                                <tbody>
                                                    @foreach ($tRegist as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->loc_asset }}</td>
                                                            <td>
                                                                <a class="btn btn-success" href="/reports/kartu_stock_asset/{{ $item->register_code }}/detail"><i class="fas fa-book"></i> Detail</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
