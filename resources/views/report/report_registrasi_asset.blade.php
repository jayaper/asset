          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Report Data Registrasi Asset </li>
                  </ol>
                </div>
              ...
              <!-- <a href="{{ route('laman_tambah_registrasi_asset') }}" class="btn btn-square btn-primary">Add Data Asset</a>
                ...
                <a href="/registration/export-data-assets" class="btn btn-square btn-primary" role="button">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <div class="table-responsive product-table">
                                  <table class="display" id="coba" style="min-width: 100%; border-collapse: separate; border-radius: 8px; overflow: hidden;">
                                      <thead>
                                          <tr>
                                            <!-- <th>Asset Tag</th>
                                            <th>Asset Name</th>
...
var table = $('#coba').DataTable({
    ...
    //         width: "50px", // Ensure enough space for Asset Tag
    //         render: function (data, type, row) {
    //             return `<div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="${data}">${data}</div>`;
    //         },
    //     },
    //     { targets: "_all", width: "auto" }, // Default auto-width for other columns
    // ],
    "ajax": {
        "url": "/reports/get_data_registrasi_asset_report",
        "type": "GET",
        "dataSrc": ""
    },
    "columns": [
            ...
            "render": function(data, type, row) {
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${row.id}">
                        <a class="dropdown-item" href="/reports/registration/generate-pdf/${row.register_code}" target="_blank">Cetak QR Code</a>
                        <a class="dropdown-item" href="/reports/registration/detail_data_registrasi_asset/${row.register_code}" target="_blank">Detail Barang Asset</a>
                        ${approveButton}
                    </div>
                </div>`;
            }
