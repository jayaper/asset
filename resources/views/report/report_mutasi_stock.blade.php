                                  ...
                                  <table class="display" id="coba" style="min-width: 100%; border-collapse: separate; border-radius: 8px; overflow: hidden;">
                                      <thead>
                                          <tr>
                                              ...
                                              <th>Mutasi Stock Code</th>
                                              <th>User Create</th>
                                              <!-- <th>Approval 1</th> -->
                                              <th>Approval 1 Date</th>
                                              <th>Approval 1 User</th>
                                              <!-- <th>Approval 2</th>  -->
                                              <th>Approval 2 Date</th>
                                              <th>Approval 2 User</th>
                                              <!-- <th>Approval 3</th> -->
                                              <th>Approval 3 Date</th>
                                              <th>Approval 3 User</th>
                                              <th>Asset Name</th>
                                              <th>Quantity</th>
                                              <th>Satuan</th>
                                              <th>From Location</th>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js" integrity="sha384-+sLIOodYLS7CIrQpBjl+C7nPvqq+FbNUBDunl/OZv93DB7Ln/533i8e/mZXLi/P+" crossorigin="anonymous"></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
      ...
      "ajax": {
          "url": "/reports/get_data_mutasi_stock",
          "type": "GET",
          "dataSrc": ""
      },
      "columns" : [
        ...
        },
        {
                data: "appr_1_date",
                render: function (data, type, row) {
                    return data ? data : "Belum Approve"; // Handle null values
                }
            },
            { data : "appr_1_user"},
            {
