...
input:checked + .slider:before {
  ...
  <body>
					...
					<div class="card-body"> 
						<div class="btn-showcase">
                            <div class="button_between">
                                <button class="btn btn-square btn-primary" type="button" data-toggle="modal" data-target="#addDataUser">+ Add Data Permission</button>
                            ...
                            <div class="modal-body">
                              <form id="addUserForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                      <div id="additional-form-container"></div>
                                    </div>
                      ...
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                          <div>
                              ...
                              @else
                                  <a href="{{ $permission->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                              @endif
                          </div>
                          <div>
                              <!-- Next Button -->
                              @if ($permission->hasMorePages())
                                  <a href="{{ $permission->nextPageUrl() }}" class="btn btn-link">Next >></a>
                              @else
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            <span>Page {{ $permission->currentPage() }} of {{ $permission->lastPage() }}</span>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    const username = $(this).data('username'); // Get username
    const email = $(this).data('email'); // Get email
    const password = $(this).data('password'); // Get password
    const role = $(this).data('role');
    const locationNow = $(this).data('location_now'); // Get current location ID
