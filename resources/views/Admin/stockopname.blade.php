        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Stock Opname Name List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Stock Opname Name List</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-header pb-0">
					...
					<div class="card-body"> 
						<div class="btn-showcase">
                            ...
                            <a href="{{ url('/admin/stockopname/add_data_stockopname') }}" class="btn btn-square btn-primary">+ Add Data Stock Opname</a>
                                <button class="btn btn-square btn-primary" type="button" data-toggle="modal" data-target="#importDataExcel"> Import Data Excel Stock Opname</button>
                                <a href="{{ url('/admin/stockopname/export_pdf')}}" class="btn btn-square btn-primary" target="_blank">Export Data PDF</a>
                    ...
                    {{-- <div class="modal fade" id="importDataExcel" tabindex="-1" role="dialog" aria-labelledby="importDataExcelLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="importDataExcelLabel">Import Data Excel Stock Opname Asset</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                <form action="{{url ('/stockopname/upload_excel')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="importDataExcel" tabindex="-1" role="dialog" aria-labelledby="importDataExcelLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('import.stockopname') }}" method="POST" enctype="multipart/form-data">
                @csrf
          ...
          <div class="px-4">
            ...
            @endif
                    ...
                    <div class="card-body">
                      ...
                      <form action="{{ route('stockopname.filter') }}" method="GET">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="d-flex justify-content-between mb-3 mt-3">
                            <h5>Stock Opname Data</h5> <!-- Add a heading for the table if needed -->
                                    ...
                                    <tr class="text-center">
                                      {{-- <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endif
                                            @if($moveout->verify == 'no')
                                            <a href="{{ url('/admin/stokopname/edit_detail_data_stock_opname/'.  $moveout->opname_id) }}" title="Edit">
                                                  <i class="fas fa-edit"></i>
                                              </a>
                                            @endif
                                              <a href="{{ url('/admin/stockopname/get_detail_data_stock_opname/' . $moveout->opname_id) }}" title="Detail">
                                            ...
                                            <a href="{{ url('admin/stockopname/export_pdf', $moveout->opname_id) }}" target="_blank"><i class="fas fa-print mx-1"></i></a>
