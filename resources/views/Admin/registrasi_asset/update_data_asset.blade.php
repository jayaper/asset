        ...
        <form action="{{ url('/admin/registrasi_asset/update_data_registrasi_asset/'. $asset->id)}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" name="register_code" class="form-control" value="{{ $asset->register_code}}" readonly>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" name="serial_number" id="serial_number" class="form-control" value="{{ $asset->serial_number }}" required>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <select name="category_asset" id="edit-category_asset" class="form-control">
                        <option value="{{ $asset->cat_name }}" selected disabled>
                            {{ $asset->cat_name }}
                        </option>
                    </select>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="number" name="qty" id="qty" class="form-control" placeholder="Masukkan Quantity" required min="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" value="{{ $asset->qty }}" />
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="number" name="width" id="width" class="form-control" placeholder="Masukkan Width Barang" required min="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" value="{{ $asset->width }}" />
                </div>

                <!-- Height -->
                <div class="col-sm-6 mb-3">
                    <label for="height">Height :</label>
                    <input type="number" name="height" id="height" class="form-control" placeholder="Masukkan Height Barang" required min="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" value="{{ $asset->height }}" />
                </div>

                <!-- Depth -->
                <div class="col-sm-6 mb-3">
                    <label for="depth">Depth :</label>
                    <input type="number" name="depth" id="depth" class="form-control" placeholder="Masukkan Depth Barang" required min="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" value="{{ $asset->depth }}" />
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <select name="layout" id="layout" class="form-control">
                        <option value="{{ $asset->layout_id }}" selected>{{ $asset->layout_name }}</option>
                    </select>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="date" name="register_date" id="register_date" class="form-control" value="{{$asset->register_date}}" required>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <select name="supplier" id="supplier" class="form-control">
                        <option value="{{ $asset->supplier_code }}" selected>{{ $asset->supplier_name }}</option>
                    </select>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" name="purchase_number" id="purchase_number" class="form-control" value="{{$asset->purchase_number}}" required>
                </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <select name="warranty" id="edit-warranty" class="form-control">
                        <option value="{{ $asset->warranty_id }}">{{ $asset->warranty_name }}</option>
                    </select>
                </div>
