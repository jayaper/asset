                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                <div class="col-sm-12">
                                                    <label for="type_code">Type Code : </label>
                                                    <input type="text" name="edit-type_code" id="edit_type_code" class="form-control" required>
                                                </div>
                                                  <div class="col-sm-12">
                                                      <label for="type_name">Type Name : </label>
                                                      <input type="text" name="edit-type_name" id="edit_type_name" class="form-control" required>
                                                  </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        <div class="d-flex justify-content-between mb-3 mt-3">
                            <h5>Tipe Asset Data</h5> <!-- Add a heading for the table if needed -->
