        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="section">
            ...
            <div class="col-sm-12">
                ...
                <input type="date" name="out_date" id="out_date" class="form-control" value="{{ $moveOutAssets->out_date}}" required>
            </div>
            <div class="col-sm-12">
...
<div class="col-sm-12">
    ...
    <select name="dest_loc" id="dest_loc" class="form-control" required>
        <option value="{{$moveOutAssets->dest_loc}}">{{$moveOutAssets->destination_location}}</option>
    </select>
</div>
            ...
            <div class="col-sm-12">
                <label for="out_desc">Deskripsi Movement Out:</label>
                    <input type="text" name="out_desc" id="out_desc" class="form-control" value="{{ $moveOutAssets->out_desc }}" required>
                </div>
                <div class="col-sm-12">
                                    ...
                                    <div class="asset-fields">
                                        <div class="row">
                                            ...
                                            <select name="asset_id[]" id="asset_id" class="form-control asset-select" required>
                                                ...
                                                <option value="{{ $asset->id }}">{{ $asset->asset_model }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            <div class="col-sm-4">
