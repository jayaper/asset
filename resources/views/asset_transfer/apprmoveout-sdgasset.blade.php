  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Approval SDG Asset - Movement Out</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Approval SDG Asset - Movement Out</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Approval SDG Asset - Movement Out</h5>
                    <span>Asset yang sudah di request untuk melakukan movement akan melalui approval terlebih dahulu, dilanjutkan persetujuan oleh SDG!</span>
                  </div>
					<div class="card-body"> 
                              ...
                              <div class="modal-dialog modal-md">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">Update Status Approval SDG Asset</h5>
                                ...
                                @foreach($moveouts as $moveout)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            @can('btn at action approval sdg')
                                              @if($moveout->appr_3 != 2 && $moveout->appr_3 != 4)
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/asset-transfer/approval-sdg-asset/edit/' + $('#out_id').val(),
