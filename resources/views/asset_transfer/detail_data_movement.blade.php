            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title mt-4">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Detail Data Asset Movement</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Detail Data Asset Movement</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-bordered mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $condition = $conditions->firstWhere('condition_id', $asset->condition);
                                                    @endphp
