  ...
  <body>
    ...
    <div class="card">
        <div class="card-header">
            <h3><b>Detail Data Asset Movement</b></h3>
        </div>
        <div class="card-body">
            <form action="{{ url('/moveout/update', $moveOutAssets->out_id) }}" method="POST">
                ...
                <!-- Row 1: Tanggal Movement Out -->
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <label for="out_date">Tanggal Movement Out:</label>
                        <input type="date" name="out_date" id="out_date" class="form-control" value="{{ $moveOutAssets->out_date }}" readonly>
                    </div>
                    <div class="col-sm-6">
                        <label for="from_loc">Lokasi Asal:</label>
                        <input type="text" name="from_loc" id="" value="{{ $moveOutAssets->from_location }}" class="form-control" readonly>
                    </div>
                </div>

                <!-- Row 2: Lokasi Tujuan & Deskripsi -->
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <label for="dest_loc">Lokasi Tujuan:</label>
                            <input type="text" name="dest_loc" class="form-control" value="{{ $moveOutAssets->destination_location }}" readonly></input>
                    </div>
                    <div class="col-sm-6">
                        <label for="out_desc">Deskripsi Movement Out:</label>
                        <input type="text" name="out_desc" id="out_desc" class="form-control" value="{{ $moveOutAssets->out_desc }}" readonly>
                    </div>
                </div>

                <!-- Row 3: Alasan Movement Out -->
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <label for="reason_id">Alasan Movement Out:</label>
                        <select name="reason_id" id="reason_id" class="form-control" readonly>
                            <option value="{{ $moveOutAssets->reason_id }}">{{ $moveOutAssets->reason_name }}</option>
                ...
                <!-- Asset Fields -->
                <div id="assetFieldsContainer" class="mb-3">
...
<script>
 $(document).ready(function () {
    ...
    function populateAssetField($field, detail) {
        ...
        $field.find('input[name="merk[]"]').val(detail.brand_name).prop('readonly', true);
        $field.find('input[name="qty[]"]').val(detail.qty).prop('readonly', true);
        $field.find('input[name="satuan[]"]').val(detail.uom_name).prop('readonly', true);
