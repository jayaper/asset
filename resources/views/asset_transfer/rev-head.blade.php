                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Movement Record</li>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header pb-0">
                                    ...
                                    <h5>Movement Record</h5>

                                    <span>Record dari data movement asset yang sudah berhasil untuk move.</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive product-table"
                                        ...
                                        <div class="d-flex justify-content-between mb-3 mt-3">
                                            ...
                                            <h5>Review Asset Data</h5> <!-- Add a heading for the table if needed -->
                                                ...
                                                @foreach ($moveins as $movein)
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ url('/asset-transfer/detail-request-moveout/' . $movein->out_id) }}"
                                                                title="Detail">
