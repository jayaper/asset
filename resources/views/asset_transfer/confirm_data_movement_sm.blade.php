                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            @if (
                                                                $movein->is_confirm != 3 &&
                                                                    $movein->is_confirm != 4 &&
                                                                    $movein->dest_loc == auth()->user()->location_now &&
                                                                    auth()->user()->role)
                                                            ...
                                                            <a href="{{ route('moveout.preview', $movein->out_id) }}"
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: '{{ route('update.confirm_sm', '') }}' + '/' + $('#in_id').val(),
                ...
                success: function(response) {
                    ...
                    window.location.href = '/sm/movement/data_confirm';
