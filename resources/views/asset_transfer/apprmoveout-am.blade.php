...
<body>
            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Approval AM - Movement Out</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Approval AM - Movement Out</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Approval AM - Movement Out</h5>
                                    <span>Asset yang sudah di request untuk melakukan movement akan melalui approval terlebih dahulu, dimulai dari Area Manager!</span>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="updateForm">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label for="appr_1">Approval AM: </label>
                                                            <select name="appr_1" id="appr_1"
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            const moveoutId = $(this).data('id');
            const moveoutNo = $(this).data('no');
            const moveoutApproval = $(this).data('approval');
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/asset-transfer/approval-ops-am/update/' + $('#out_id').val(),
                method: 'POST',
