                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    @endif
                              ...
                              <div class="modal-dialog modal-md">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">Update Status Approval RM</h5>
                       ...
                       <div class="modal fade" id="MoveOutDetailModal" tabindex="-1" role="dialog" aria-labelledby="MoveOutModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="MoveOutModalLabel">Detail Movement Out</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>: 
                                <span id="asset-img">
                                    <img src="#" id="image-preview" alt="Gambar Asset" class="img-fluid rounded">
                                </span>
                            </td>
                        </tr>
                    </tbody>
