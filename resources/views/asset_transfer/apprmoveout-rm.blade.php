...
<body>
            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Approval RM - Movement Out</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Approval RM - Movement Out</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Approval RM - Movement Out</h5>
                                    <span>Asset yang sudah di request untuk melakukan movement akan melalui approval terlebih dahulu, dilanjutkan oleh Region Manager!</span>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Update Status Approval
                                                    RM</h5>
                                            ...
                                            <form id="updateForm">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label for="appr_2">Approval RM: </label>
                                                            <select name="appr_2" id="appr_2"
                                ...
                                <div class="modal fade" id="MoveOutDetailModal" tabindex="-1" role="dialog"
                                    aria-labelledby="MoveOutModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="MoveOutModalLabel">Detail Movement Out
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>: <span id="moveout-id"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>No Movement Out</strong></td>
                                                            <td>: <span id="moveout-no"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Tanggal</strong></td>
                                                            <td>: <span id="out-date"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Lokasi Asal</strong></td>
                                                            <td>: <span id="from-loc"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Lokasi Tujuan</strong></td>
                                                            <td>: <span id="dest-loc"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>ID Movement In</strong></td>
                                                            <td>: <span id="in-id"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Deskripsi</strong></td>
                                                            <td>: <span id="out-desc"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>ID Asset</strong></td>
                                                            <td>: <span id="asset-id"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Nama Asset</strong></td>
                                                            <td>: <span id="asset-name"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Tag Asset</strong></td>
                                                            <td>: <span id="asset-tag"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Serial Number</strong></td>
                                                            <td>: <span id="serial-number"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Brand</strong></td>
                                                            <td>: <span id="asset-brand"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Quantity</strong></td>
                                                            <td>: <span id="asset-qty"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Satuan</strong></td>
                                                            <td>: <span id="asset-uom"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Condition</strong></td>
                                                            <td>: <span id="asset-cond"></span></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>:
                                                                <span id="asset-img">
                                                                    <img src="#" id="image-preview"
                                                                        alt="Gambar Asset" class="img-fluid rounded">
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            @can('btn at action approval rm')
                                                                @if ($moveout->regional == $user->location_now)
                                                                    @if ($moveout->appr_2 == 1)
                                                                ...
                                                                @endif
                                                            @endcan
                                                            <a href="{{ url('/asset-transfer/detail-request-moveout/' . $moveout->out_id) }}" title="Detail">
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/asset-transfer/approval-ops-rm/edit/' + $('#out_id').val(),
