...
<body>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header pb-0">
                                    ...
                                    <span>Asset yang sudah di request untuk melakukan movement akan melalui approval terlebih dahulu, disetujui oleh SDG dan di konfirmasi oleh store manager ketika barang sudah datang!</span>
                                ...
                                <div class="modal fade" id="addDataMoveIn" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-md">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="exampleModalLabel">Add Data Confirm Asset
                                                </h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <input type="date" name="out_date" id="out_date"
                                                                class="form-control"
                                                                placeholder="Enter Tanggal Delivery Order" required>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <input type="text" name="out_desc" id="out_desc"
                                                                class="form-control"
                                                                placeholder="Enter Deskripsi Delivery Order" required>
                                    ...
                                    <div class="modal-dialog modal-md">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="exampleModalLabel">Update Move In
                                                    Confirmation Asset</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <select name="is_confirm" id="is_confirm"
                                                                class="form-control" required>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="brandModalLabel">Detail Delivery Order
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><strong>No Delivery Order:</strong> <span id="moveout-no"></span>
                                                </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive product-table"
                                        ...
                                        <div class="d-flex justify-content-between mb-3 mt-3">
                                            ...
                                            <h5>Confirmation Asset Data</h5>
                                            <!-- Add a heading for the table if needed -->
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($moveins as $movein)
                                                    <tr class="text-center">
                                                        ...
                                                        <td>{{ $movein->out_date }}</td>

                                                        <td>{{ $movein->from_location }}</td>
                                                            ...
                                                            @if ($user->location_now == $movein->dest_loc && $movein->is_confirm != 3 && $movein->is_confirm != 4)
                                                                @can('btn at action confirm')
                                                                    <a href="javascript:void(0);" class="edit-button"
                                                                        data-id="{{ $movein->out_id }}" title="Edit">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                @endcan
                                                            @endif
                                                            <a href="{{ url('/asset-transfer/pdf-request-moveout', $movein->out_id) }}"
                                                                target="_blank"><i class="fas fa-print mx-1"></i></a>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center mt-4">
                                            ...
                                            <div>
                                                ...
                                                @if ($moveins->onFirstPage())
                                                    <span class="disabled">
                                                        << Previous</span>
                                                        @else
                                                            <a href="{{ $moveins->previousPageUrl() }}"
                                                                class="btn btn-link">
                                                                << Previous</a>
                                                @endif
                                            ...
                                            <div>
                                                ...
                                                @if ($moveins->hasMorePages())
                                                    <a href="{{ $moveins->nextPageUrl() }}" class="btn btn-link">Next
                                                        >></a>
                                                @else
                                        ...
                                        <div class="d-flex justify-content-center mt-2">
                                            ...
                                            <span>Page {{ $moveins->currentPage() }} of
                                                {{ $moveins->lastPage() }}</span>
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            const moveoutId = $(this).data('id'); // Get the moveout id from data attribute

            const moveoutNo = $(this).data('no'); // Get moveout number from data attribute

            const moveoutApproval = $(this).data('approval'); // Get approval status from data attribute
            ...
            $('#is_confirm').val(moveoutApproval);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: '{{ url('/asset-transfer/confirm-asset/edit', '') }}' + '/' + $('#in_id').val(),
                ...
                success: function(response) {
                    ...
                    window.location.href = '/asset-transfer/confirm-asset';

                },

                error: function(jqXHR) {

                    alert(jqXHR.responseJSON?.message || "Update failed");
