                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label for="permission_name">Role Name</label>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive product-table"
                                        ...
                                        <div class="d-flex justify-content-between mb-3 mt-3">
                                            <h5>Role Data</h5> <!-- Add a heading for the table if needed -->
                                            ...
                                            <div>
                                                ...
                                                @if ($permission->onFirstPage())
                                                    <span class="disabled">
                                                        << Previous</span>
                                                        @else
                                                            <a href="{{ $permission->previousPageUrl() }}"
                                                                class="btn btn-link">
                                                                << Previous</a>
                                                @endif
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-center mt-2">
                                            <span>Page {{ $permission->currentPage() }} of
                                                {{ $permission->lastPage() }}</span>
                                        </div> --}}
                                    </div>
                                </div>
                            </div>
