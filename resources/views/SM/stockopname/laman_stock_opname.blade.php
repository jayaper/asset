                  ...
                  <div class="card-header pb-0">
					...
					<div class="card-body"> 
						<div class="btn-showcase">
                            ...
                            <a href="{{ url('/sm/stockopname/add_data_stockopname') }}" class="btn btn-square btn-primary">+ Add Data Stock Opname</a>
                                ...
                                <a href="{{ url('/sm/stockopname/export_pdf')}}" class="btn btn-square btn-primary" target="_blank">Export Data PDF</a>
