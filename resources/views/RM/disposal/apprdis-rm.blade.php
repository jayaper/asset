  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Approval RM - Disposal Out</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Approval RM - Disposal Out</li>
                  </ol>
                </div>
              </div>
            </div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            @if($moveout->appr_2 != 2 && $moveout->appr_2 != 4)
                                              ...
                                              @endif
                                              <a href="{{ url('/rm/get_detail_data_disposal/' . $moveout->out_id) }}" title="Detail">
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/rm/apprmoveout-rms/edit/' + $('#out_id').val(),
                method: 'POST', // Menggunakan PUT untuk memperbarui data
                data: $(this).serialize(), // Serialisasi data form untuk dikirim
                success: function(response) {
                    if(response.status === 'success') {
                        window.location.href = '/rm/apprdis-rm'; // Redirect ke halaman yang sudah diatur
                    }
                },
                error: function(jqXHR) {
                    const message = jqXHR.responseJSON?.message || 'Failed to update moveout.';
