    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#supplier').select2({
                ...
                ajax: {
                    url: '/registration/get-supplier-json', // Route to fetch regions
                    dataType: 'json',
                    delay: 250, // Delay to avoid overloading the server
                    data: function(params) {
                        return {
        ...
        $(document).ready(function() {
            ...
            $('#register_location').select2({
                ...
                ajax: {
                    url: '/registration/get-resto-json', // Route to fetch regions
                    dataType: 'json',
                    delay: 250, // Delay to avoid overloading the server
                    data: function(params) {
                        return {
        ...
        $(document).ready(function() {
            // Fetch regions and populate the dropdown
            $.ajax({
                url: '/registration/get-condition-json', // Route to fetch regions
                method: 'GET',
                success: function(data) {
                    ...
                    $.each(data, function(index, condition) {
                        regionSelect.append($('<option>', {
                            value: condition
                            .condition_id, // Assuming 'id' is the unique identifier for the region
                            text: condition
                                .condition_name // Assuming 'name' is the display name of the region
                        }));
                    });
                }
            });
