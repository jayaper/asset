                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                    ...
                                    <div class="btn-showcase">
                                        <div class="button_between">
                                            <button class="btn btn-square btn-primary" type="button"
                                                data-toggle="modal" data-target="#addDataAsset">+ Add Data
                                                Asset</button>
                                ...
                                <div class="modal fade" id="addDataAsset" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <!-- Menggunakan modal-lg untuk memperlebar modal -->
                                        <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" name="asset_code" id="asset_code"
                                                                class="form-control" placeholder="Enter Asset Code"
                                                                required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="asset_model">Asset Model:</label>
                                                            <input type="text" name="asset_model" id="asset_model"
                                                                class="form-control" placeholder="Enter Asset Model"
                                                                required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="asset_status">Asset Status:</label>
                                                            <input type="text" name="asset_status"
                                                                id="asset_status" class="form-control"
                                                                placeholder="Enter Asset Status" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="asset_quantity">Asset Quantity:</label>
                                                            <input type="text" name="asset_quantity"
                                                                id="asset_quantity" class="form-control"
                                                                placeholder="Enter Asset Quantity" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="asset_image">Asset Image:</label>
                                                            <input type="text" name="asset_image" id="asset_image"
                                                                class="form-control" placeholder="Enter Asset Image"
                                                                required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                    id="saveAssetButton">Save Changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailDataAssetLabel">Detail Barang Asset
                                                </h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" method="post">
                    <!-- Asset ID, hidden field for storing the ID -->
                    <input type="hidden" id="asset_id" name="asset_id">
                    
                    <!-- Asset Code -->
                    <div class="form-group">
                        <label for="edit-asset_code">Asset Code</label>
                        <input type="text" class="form-control" id="edit-asset_code" name="asset_code" required>
                    </div>
                    
                    <!-- Asset Model -->
                    <div class="form-group">
                        <label for="edit-asset_model">Asset Model</label>
                        <input type="text" class="form-control" id="edit-asset_model" name="asset_model" required>
                    </div>
                    
                    <!-- Asset Quantity -->
                    <div class="form-group">
                        <label for="edit-asset_quantity">Quantity</label>
                        <input type="number" class="form-control" id="edit-asset_quantity" name="asset_quantity" required>
                    </div>
                    
                    <!-- Asset Status -->
                    <div class="form-group">
                        <label for="edit-asset_status">Asset Status</label>
                        <select class="form-control" id="edit-asset_status" name="asset_status" required>
                    ...
                    <!-- Asset Image -->
                    <div class="form-group">
                        <label for="edit-asset_image">Asset Image URL</label>
                        <input type="text" class="form-control" id="edit-asset_image" name="asset_image">
                    </div>
                    
                    <!-- Priority ID -->
                    <div class="form-group">
                        <label for="edit-priority_id">Priority</label>
                        <select class="form-control" id="edit-priority_id" name="priority_id">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="edit-type_id" name="type_id">
                    ...
                    <!-- UOM ID -->
                    <div class="form-group">
                        <label for="edit-uom_id">Unit of Measure</label>
                        <select class="form-control" id="edit-uom_id" name="uom_id">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        .redirect_url; // Redirect ke halaman yang sudah diatur
                    }
                },
                error: function(jqXHR) {
                    const message = jqXHR.responseJSON?.message || 'Failed to update Asset.';
