...
<body>
                                            ...
                                            <div id="assetFieldsContainer" class="mt-4">
                                                ...
                                                <div class="asset-fields">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {{-- <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label for="qty">Quantity System:</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            document.querySelector('#out_date').addEventListener('focus', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire('Sukses!', 'Stock Opname Berhasil Ditambahkan.', 'success')
                                .then(() => {   
    ...
    <script>
        $(document).ready(function() {
            const table = $('#assetTable').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url: '/api/ajaxGetDataRegistAssetSO/{{ $user->location_now }}',
                    type: 'GET'
                },
                columns: [{
                        data: 'register_code'
