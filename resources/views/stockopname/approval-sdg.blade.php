            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Stock Opname Approval SDG Assets</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Stock Opname Approval SDG Assets</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Stock Opname Approval SDG Assets</h5>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <select name="confirm_so" id="confirm_so"
                                                                ...
                                                                @foreach ($approvals as $approval)
                                                                    @if ($approval->approval_id != 2 && $approval->approval_id != 1)
                                                    ...
                                                    @foreach ($stockopnames as $item)
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="/asset-transfer/pdf-request-moveout/{{ $item->id }}"
                                                                    target="_blank"><i
                    ...
                    fetch(`/admin/moveouts/get-asset-details/${assetId}`)
                        ...
                        .then(data => {
                            ...
                            if (data) {
                                ...
                                container.querySelector('input[name="serial_number[]"]').value = data
                                    .serial_number || '';
                                container.querySelector('input[name="register_code[]"]').value = data
                                    .register_code || '';
                            } else {
