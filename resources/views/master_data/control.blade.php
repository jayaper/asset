  ...
  <body>
                                ...
                                @foreach($controls as $control)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-control-checklist', $control->control_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveControlButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-control-checklist' + $('#control_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            const controlName = $(this).data('control_name'); // Ambil control_name dari atribut data
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-control-checklist/' + $('#control_id').val(),
