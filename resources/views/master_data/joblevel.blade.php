  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="joblevel_name">Job Level Name : </label>
                                                      <input type="text" name="joblevel_name" id="edit-joblevel_name" class="form-control" required>
                                                  </div>
                    ...
                    data.forEach(function(joblevel) {
                        rows += `
                            <tr>
                                ...
                                <form class="delete-form" action="{{ url('/master-data/delete-new-data') }}/${joblevel.joblevel_id}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveJobLevelButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-job-level' + $('#joblevel_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            $('#edit-joblevel_name').val(joblevelName);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-job-level/' + $('#joblevel_id').val(),
