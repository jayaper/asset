  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="condition_name">Condition Name : </label>
                                                      <input type="text" name="condition_name" id="edit-condition_name" class="form-control" required>
                                                  </div>
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveConditionButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-condition' + $('#condition_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            $('#edit-condition_name').val(conditionName);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-condition/' + $('#condition_id').val(),
