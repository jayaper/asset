  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="reason_name">Reason Name : </label>
                                                      <input type="text" name="reason_name" id="edit-reason_name" class="form-control" required>
                                                  </div>
                                ...
                                @foreach($reasons as $reason)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-alasan-mutasi', $reason->reason_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveReasonButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-alasan-mutasi' + $('#reason_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            $('#edit-reason_name').val(reasonName);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-alasan-mutasi/' + $('#reason_id').val(),
