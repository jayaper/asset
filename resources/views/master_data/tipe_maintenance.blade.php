        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Tipe Maintenance Data List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Tipe Maintenance Data List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Tipe Maintenance Data List</h5>
					...
					<div class="card-body">
						<div class="btn-showcase">
                            <div class="button_between">
                                <button class="btn btn-square btn-primary" type="button" data-toggle="modal" data-target="#addDataTipeMaintenance">+ Add Data Tipe Maintenance</button>
                    ...
                    <div class="modal fade" id="addDataTipeMaintenance" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add Data Tipe Maintenance</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="addTipeMaintenanceForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                        <label for="mtc_type_name">Nama Tipe Maintenance : </label>
                                        <input type="text" name="mtc_type_name" id="mtc_type_name" class="form-control" required>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="saveTipeMaintenanceButton">Save changes</button>
                            </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="updateModal" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-md">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">Update Tipe Maintenance</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true">&times;</span>
                                          </button>
                                      </div>
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="mtc_type_name">Nama Tipe Maintenance : </label>
                                                      <input type="text" name="mtc_type_name" id="edit-mtc_type_name" class="form-control" required>
                                                  </div>
                                                  <input type="hidden" name="mtc_type_id" id="mtc_type_id">
                                              </div>
                                          </div>
                                          <div class="modal-footer">
          ...
          <!-- Modal -->
<div class="modal fade" id="TipeMaintenanceDetailModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Maintenance Type Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p><strong>ID:</strong> <span id="mtc_type_id" class="mtc_type_id"></span></p>
                <p><strong>Name:</strong> <span id="mtc_type_name" class="mtc_type_name"></span></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        ...
                        <table class="table table-striped display" id="coba" style="width: 100%;">
                            ...
                            <tbody>
                                @foreach($typesMaintenance as $typeMaintenance)
                                    <tr class="text-center">
                                        <td>{{ $typeMaintenance->mtc_type_id }}</td>
                                        <td>{{ $typeMaintenance->mtc_type_name }}</td>
                                        <td class="text-center">
                                            <a href="javascript:void(0);" class="edit-button"
                                            data-id="{{ $typeMaintenance->mtc_type_id }}"
                                            data-name="{{ $typeMaintenance->mtc_type_name }}"
                                            title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#TipeMaintenanceDetailModal"
                                            data-id="{{ $typeMaintenance->mtc_type_id }}"
                                            data-name="{{ $typeMaintenance->mtc_type_name }}"
                                            title="Detail">
                                                <i class="fas fa-book"></i>
                                            </a>
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-type-maintenance-asset', $typeMaintenance->mtc_type_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                          <div>
                              <!-- Previous Button -->
                              @if ($typesMaintenance->onFirstPage())
                                  <span class="disabled"><< Previous</span>
                              @else
                                  <a href="{{ $typesMaintenance->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                              @endif
                          </div>
                          <div>
                              <!-- Next Button -->
                              @if ($typesMaintenance->hasMorePages())
                                  <a href="{{ $typesMaintenance->nextPageUrl() }}" class="btn btn-link">Next >></a>
                              @else
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            <span>Page {{ $typesMaintenance->currentPage() }} of {{ $typesMaintenance->lastPage() }}</span>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveTipeMaintenanceButton').click(function (e) {
                e.preventDefault();

                // Ambil data form
                var mtcTypeName = $('#mtc_type_name').val();
                // Kirimkan data menggunakan Ajax
                $.ajax({
                    url: '/master-data/add-new-type-maintenance-asset' + $('#mtc_type_id').val(), // Pastikan ini adalah URL yang benar
                    method: 'POST', // Pastikan ini menggunakan metode PUT
                    data: {
                    mtc_type_name: mtcTypeName
                }, // Kirim data dari form
                success: function(response) {
                      console.log(response);
                      // Cek apakah response berisi error atau success
                      if (response.status === 'success') {
                          $('#addTipeMaintenanceForm').modal('hide');
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            const mtcTypeId = $(this).data('id');
            const mtcTypeName = $(this).data('name');

            // Isi input dengan data
            $('#mtc_type_id').val(mtcTypeId);
            $('#edit-mtc_type_name').val(mtcTypeName);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-type-maintenance-asset/' + $('#mtc_type_id').val(),
  ...
  $(document).ready(function() {
      ...
      $('.detail-button').on('click', function() {
            var mtcTypeId = $(this).data('id');
            var mtcTypeName = $(this).data('name');

            $('#mtc_type_id').text(mtcTypeId);
            $('#mtc_type_name').text(mtcTypeName);


          // Show the modal
          $('#TipeMaintenanceDetailModal').modal('show');
      });
  });
</script>
    ...
    <script>
        ...
        if (confirm('Apakah Anda yakin ingin menghapus Data Tipe Maintenance ini?')) {
