...
<div class="modal fade" id="TipeMaintenanceDetailModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                @foreach($typesMaintenance as $typeMaintenance)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/admin/tipe_maintenance/delete', $typeMaintenance->mtc_type_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveTipeMaintenanceButton').click(function (e) {
                ...
                $.ajax({
                    url: '/add-tipe-maintenance' + $('#mtc_type_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/tipe_maintenance/edit/' + $('#mtc_type_id').val(),
