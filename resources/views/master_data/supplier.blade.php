  ...
  <body>
                                ...
                                @foreach($suppliers as $supplier)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-supplier', $supplier->supplier_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                {{-- @method('DELETE') --}}
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveSupplierButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-supplier', // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-supplier/' + $('#supplier_id').val(),
