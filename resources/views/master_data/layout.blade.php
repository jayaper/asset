  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                <div class="col-sm-12">
                                                    <label for="layout_code">Layout Code : </label>
                                                    <input type="text" name="layout_code" id="edit-layout_code" class="form-control" required>
                                                </div>
                                                  <div class="col-sm-12">
                                                      <label for="layout_name">Layout Name : </label>
                                                      <input type="text" name="layout_name" id="edit-layout_name" class="form-control" required>
                                                  </div>
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveLayoutButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-layout' + $('#layout_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        $(document).on('click', '.edit-button', function() {
            ...
            $('#edit-layout_name').val(layoutName);
            $('#edit-layout_code').val(layoutCode);
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-layout/' + $('#layout_id').val(),
