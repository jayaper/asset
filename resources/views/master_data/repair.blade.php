  ...
  <body>
                                ...
                                @foreach($repairs as $repair)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-repair', $repair->repair_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveRepairButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-repair' + $('#repair_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-repair/' + $('#repair_id').val(),
