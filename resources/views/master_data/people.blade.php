  ...
  <body>
                            ...
                            <tbody>
                                @foreach($peoples as $people)
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $people->Position_Nama }}</td>
                                        <td>{{ $people->Job_Level }}</td>
                    ...
                    data.forEach(function(people) {
                        rows += `
                            <tr>
                                ...
                                <form class="delete-form" action="{{ url('/master-data/delete-new-data') }}/${people.people_id}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#savePeopleButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-maintenance' + $('#people_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-maintenance/' + $('#people_id').val(),
