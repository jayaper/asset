  ...
  <body>
                                    ...
                                    @foreach($reasonso as $reason) <!-- Change this variable name -->
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form class="delete-form" action="{{ url('/master-data/delete-new-alasan-stock-opname    ', $reason->reason_so_id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveReasonSoButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-alasan-stock-opname', // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-alasan-stock-opname/' + $('#reason_so_id').val(),
