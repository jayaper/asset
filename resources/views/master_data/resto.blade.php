                      ...
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                          <div>
                              ...
                              @else
                                  <a href="{{ $datas->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                              @endif
                          </div>
                          <div>
                              <!-- Next Button -->
                              @if ($datas->hasMorePages())
                                  <a href="{{ $datas->nextPageUrl() }}" class="btn btn-link">Next >></a>
                              @else
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            <span>Page {{ $datas->currentPage() }} of {{ $datas->lastPage() }}</span>
                        </div>
                      </div>
                  </div>
                </div>
