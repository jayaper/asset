  ...
  <body>
                                ...
                                @foreach($warrantys as $warranty)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-warranty', $warranty->warranty_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveWarrantyButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-warranty' + $('#warranty_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-warranty/' + $('#warranty_id').val(),
