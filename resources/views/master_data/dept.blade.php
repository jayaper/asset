  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="dept_name">Departement Name : </label>
                                                      <input type="text" name="dept_name" id="edit-dept_name" class="form-control" required>
                                                  </div>
                                ...
                                @foreach($depts as $dept)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-departement', $dept->dept_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveDeptButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-departement' + $('#dept_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-departement/' + $('#dept_id').val(),
