  ...
  <body>
                                ...
                                @foreach($divisions as $division)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-division', $division->division_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                {{-- @method('DELETE') --}}
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveDivisionButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-division' + $('#division_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-division/' + $('#division_id').val(),
