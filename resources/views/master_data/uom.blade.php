  ...
  <body>
                                      ...
                                      <form id="updateForm">
                                          ...
                                          <div class="modal-body">
                                              <div class="row">
                                                  <div class="col-sm-12">
                                                      <label for="uom_name">Uom Name : </label>
                                                      <input type="text" name="uom_name" id="edit-uom_name" class="form-control" required>
                                                  </div>
                                ...
                                @foreach($uoms as $uom)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form class="delete-form" action="{{ url('/master-data/delete-new-uom', $uom->uom_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveUomButton').click(function (e) {
                ...
                $.ajax({
                    url: '/master-data/add-new-uom' + $('#uom_id').val(), // Pastikan ini adalah URL yang benar
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/master-data/update-new-uom/' + $('#uom_id').val(),
