                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            @if ($moveout->appr_2 != 2 && $moveout->appr_2 != 4)
                                                                ...
                                                                @endcan
                                                            @endif
                                                            <a href="{{ url('/disposal/approval-ops-rm/detail/' . $moveout->out_id) }}"
                                                                title="Detail">
