                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="btn-showcase">
                                        <div class="button_between">
                                          @can('btn dis add request disposal')
                                            <a href="/disposal/add-request-disposal"
                                ...
                                <div class="card-body">
                                    <form action="/disposal/request-disposal" method="GET">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($moveouts as $moveout)
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            {{ $moveout->appr_3 == 3 ? 'Confirmed' : ($moveout->appr_3 == 4 ? 'Rejected' : 'Belum Approved') }}
                                                        </td>
                                                        <td>
