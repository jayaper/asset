            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Approval SDG Asset - Disposal Out</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Approval SDG Asset - Disposal Out</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Approval SDG Asset - Disposal Out</h5>
                                    <span>Asset yang sudah di request untuk melakukan disposal akan melalui approval terlebih dahulu, dilanjutkan persetujuan oleh SDG!</span>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="updateForm">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label for="appr_3">Approval SDG Asset: </label>
                                                            <select name="appr_3" id="appr_3"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><strong>ID Disposal In:</strong> <span id="in-id"></span></p>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            @if ($moveout->appr_3 == 1)
                                                                ...
                                                                @endcan
                                                            @endif
                                                            <a href="{{ url('/disposal/approval-sdg-asset/detail/' . $moveout->out_id) }}"
                                                                title="Detail">
                                                                <i class="fas fa-book"></i>
                                                            </a>
                                                        </td>
                                                        </td>
                                                        <td>{{ $moveout->appr_3_date }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
