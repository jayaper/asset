                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            @if($moveout->appr_3 == 1)
                                              ...
                                              @endcan
                                            @endif
                                              <a href="{{ url('/disposal/approval-sdg-asset/detail/' . $moveout->out_id) }}" title="Detail">
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'success') {
                        window.location.href = '/disposal/approval-sdg-asset'; // Redirect ke halaman yang sudah diatur
                    }
                },
                error: function(jqXHR) {
                    const message = jqXHR.responseJSON?.message || 'Failed to update moveout.';
