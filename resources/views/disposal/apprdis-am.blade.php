            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3>Approval AM - Disposal Out</h3>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Approval AM - Disposal Out</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Approval AM - Disposal Out</h5>
                                    <span>Asset yang sudah di request untuk melakukan disposal akan melalui approval terlebih dahulu, dimulai dari Area Manager!</span>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            @if ($moveout->appr_1 != 2 && $moveout->appr_1 != 4)
                                                                @can('btn dis action edit approval am')
                                                                ...
                                                                @endcan
                                                            @endif
                                                            <a href="{{ url('/disposal/approval-ops-am/detail/' . $moveout->out_id) }}"
                                                                title="Detail">
