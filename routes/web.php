...
Route::prefix('admin/registrasi_asset')->group(function () {
    ...
    Route::post('/admin/registrasi_asset/update_data_registrasi_asset/{id}', [RegistrasiAssetController::class, 'update']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(RequestMoveout::class)->group(function () {
        ...
        Route::post('/asset-transfer/request-moveout/update/{id}', 'updateDataMoveOut')->middleware(['permission:view at request moveout']);
    ...
    Route::controller(RequestDisposal::class)->group(function () {
        ...
        Route::post('/disposal/request-disposal/update_data_disposal/{id}', 'updateDataDisOut')->middleware(['permission:view dis request disposal']);
        ...
        //  Route::post('/admin/disouts/edit/{id}', [DisposalOutController::class, 'updateDataDisOut'])->name('update.disout');
        ...
        Route::post('/admin/update_data_disposal_out/{outId}', [DisposalOutController::class, 'updateDataDisOut']);
    ...
    Route::controller(DisApprovalOpsSDG::class)->group(function () {
        ...
        Route::get('/admin/apprdis-sdgasset', [DisposalController::class, 'HalamanAmd3']);
         ...
         Route::post('/admin/apprdis-sdgassets/edit/{id}', [DisposalController::class, 'updateDataAmd3'])->name('update.apprdis-sdgasset');
    ...
    Route::group([RoleMiddleware::class => ':admin'], function () {
        ...
        Route::post('/admin/regists/edit/{id}', [AssetsController::class, 'updateDataAssets'])->name('update.asset');
        ...
        Route::post('/admin/regist/update_master_asset/{id}', [AssetsController::class, 'updateDataAssets']);
        ...
        Route::post('/admin/review-regs/edit/{id}', [AssetsController::class, 'updateDataReview'])->name('update.review-reg');
        ...
        Route::post('/admin/brands/edit/{id}', [BrandController::class, 'updateDataBrand'])->name('update.brand');
        ...
        Route::post('/admin/categorys/edit/{id}', [CategoryController::class, 'updateDataCategory'])->name('update.category');
        ...
        Route::post('/admin/subcategorys/edit/{id}', [SubCategoryController::class, 'updateDataSubCategory'])->name('update.subcategory');
        ...
        Route::post('/admin/checklists/edit/{id}', [ChecklistController::class, 'updateDataChecklist']);
        ...
        Route::post('/admin/controls/edit/{id}', [ControlController::class, 'updateDataControl'])->name('update.control');
        ...
        Route::post('/admin/conditions/edit/{id}', [ConditionController::class, 'updateDataCondition'])->name('update.condition');
        ...
        Route::post('/admin/depts/edit/{id}', [DeptController::class, 'updateDataDept'])->name('update.dept');
        ...
        Route::post('/admin/divisions/edit/{id}', [DivisionController::class, 'updateDataDivision'])->name('update.division');
        ...
        Route::post('/admin/groupusers/edit/{id}', [GroupUserController::class, 'updateDataGroupUser'])->name('update.groupuser');
        ...
        Route::post('/admin/joblevels/edit/{id}', [JobLevelController::class, 'updateDataJobLevel'])->name('update.joblevel');
        ...
        Route::post('/admin/layouts/edit/{id}', [LayoutController::class, 'updateDataLayout'])->name('update.layout');
        ...
        Route::post('/admin/locations/edit/{id}', [LocationController::class, 'updateDataLocation'])->name('update.location');
        ...
        // Route::post('/admin/mtcs/edit/{id}', [MtcController::class, 'updateDataMtc'])->name('update.mtc');
        ...
        Route::post('/admin/peoples/edit/{id}', [PeopleController::class, 'updateDataPeople'])->name('update.people');
        ...
        Route::post('/admin/periodics/edit/{id}', [PeriodicMtcController::class, 'updateDataPeriodicMtc'])->name('update.periodic');
        ...
        Route::post('/admin/prioritys/edit/{id}', [PriorityController::class, 'updateDataPriority'])->name('update.priority');
        ...
        Route::post('/admin/reasons/edit/{id}', [ReasonController::class, 'updateDataReason'])->name('update.reason');
        ...
        Route::post('/admin/reasonsos/edit/{id}', [ReasonSoController::class, 'updateDataReasonSo'])->name('update.reasonso');
        ...
        Route::post('/admin/regions/edit/{id}', [RegionController::class, 'updateDataRegion'])->name('update.region');
        ...
        Route::post('/admin/repairs/edit/{id}', [RepairController::class, 'updateDataRepair'])->name('update.repair');
        ...
        Route::post('/admin/suppliers/edit/{id}', [SupplierController::class, 'updateDataSupplier'])->name('update.supplier');
        ...
        Route::post('/admin/types/edit/{id}', [TypeController::class, 'updateDataType'])->name('update.type');
        ...
        Route::post('/admin/uoms/edit/{id}', [UomController::class, 'updateDataUom'])->name('update.uom');
        ...
        Route::post('/admin/warrantys/edit/{id}', [WarrantyController::class, 'updateDataWarranty'])->name('update.warranty');
        ...
        Route::post('/admin/citys/edit/{id}', [CityController::class, 'updateDataCity'])->name('update.city');
        ...
        Route::post('/admin/types/edit/{id}', [TipeAssetController::class, 'updateDataTipe'])->name('update.type');
        ...
        Route::post('/admin/moveouts/edit/{outId}', [MovementOutController::class, 'updateDataMoveOut'])->name('update.moveout');
        ...
        Route::post('/admin/moveins/edit/{id}', [MovementInController::class, 'updateDataMoveIn'])->name('update.movein');
        ...
        Route::post('/admin/data-movements/edit/{id}', [MovementController::class, 'updateDataMove'])->name('update.data-movement');
        ...
        Route::post('/admin/deliverys/edit/{id}', [DeliveryController::class, 'updateDataDelivery'])->name('update.delivery');
        ...
        Route::post('/admin/confirms/edit/{id}', [DeliveryController::class, 'updateDataConfirm'])->name('update.confirm');
        ...
        Route::post('/admin/apprmoveout-ams/edit/{id}', [MovementController::class, 'updateDataAmo1'])->name('update.apprmoveout-am');
        ...
        Route::post('/admin/apprmoveout-rms/edit/{id}', [MovementController::class, 'updateDataAmo2'])->name('update.apprmoveout-rm');
        ...
        Route::post('/admin/apprmoveout-sdgassets/edit/{id}', [MovementController::class, 'updateDataAmo3'])->name('update.apprmoveout-sdgasset');
        ...
        Route::post('/admin/disins/edit/{id}', [DisposalInController::class, 'updateDataMoveIn'])->name('update.movein');
        ...
        Route::post('/admin/data-disposals/edit/{id}', [DisposalController::class, 'updateDataDisposal'])->name('update.data-disposal');
        ...
        Route::post('/admin/deliverydisposals/edit/{id}', [DeliveryDisposalController::class, 'updateDataDeliveryDisposal'])->name('update.deliverydisposal');
        ...
        Route::post('/admin/confirmdiss/edit/{id}', [DeliveryDisposalController::class, 'updateDataConfirmDis'])->name('update.confirmdis');
        ...
        Route::post('/admin/apprdis-ams/edit/{id}', [DisposalController::class, 'updateDataAmd1'])->name('update.apprdis-am');
        ...
        Route::post('/admin/apprdis-rms/edit/{id}', [DisposalController::class, 'updateDataAmd2'])->name('update.apprdis-rm');
        ...
        Route::post('/admin/stockopnames/edit/{id}', [StockOpnameController::class, 'UpdateDetailDataStockOpname'])->name('update.stockopname');
        ...
        Route::post('/admin/stockopname/update_detail_data_stock_opname/{id}', [StockOpnameController::class, 'UpdateDetailDataStockOpname']);
        ...
        Route::post('/admin/tipe_maintenance/edit/{id}', [TipeMaintenanceController::class, 'updateDataTipeMaintenance'])->name('update.tipe_maintenance');
        ...
        //  Route::post('/admin/adjuststocks/edit/{id}', [StockOpnameController::class, 'updateDataAdjustStock'])->name('update.adjuststock');
...
Route::group(['middleware' => [RoleMiddleware::class . ':am'], 'prefix' => 'am'], function () {
    ...
    Route::post('/apprmoveout-ams/edit/{id}', [AmController::class, 'updateDataAmo1'])->name('update.apprmoveout-am');
...
Route::group([RoleMiddleware::class => ':rm', 'prefix' => 'rm'], function () {
    ...
    Route::post('/apprmoveout-rms/edit/{id}', [MovementController::class, 'updateDataAmo2'])->name('update.apprmoveout-rm');

    Route::post('/confirms/edit/{id}', [DeliveryController::class, 'updateDataConfirm'])->name('update.confirm');
...
Route::group([RoleMiddleware::class => ':sm', 'prefix' => 'sm'], function () {
    ...
    Route::post('/movement/confirms/edit/{id}', [StoreManagerController::class, 'updateDataConfirm'])->name('update.confirm_sm');
