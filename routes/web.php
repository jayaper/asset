...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(Review::class)->group(function(){
     ...
     Route::controller(SoStockOpname::class)->group(function(){
        ...
        Route::get('/stockopname/edit/{so_code}', 'edit')->middleware(['permission:view stockopname edit']);
        ...
        Route::get('/stockopname/approval-sm', 'approvalSM')->middleware(['permission:view stockopname approval sm']);
        Route::post('/stockopname/approval-sm/update/{id}', 'approvalSMUpdate')->middleware(['permission:view stockopname approval sm update']);
        ...
        Route::get('/stockopname/print-pdf/{code}', 'printPDF')->middleware(['permission:view stockopname']);
